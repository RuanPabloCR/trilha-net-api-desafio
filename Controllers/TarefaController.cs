...
namespace TrilhaApiDesafio.Controllers
{
    ...
    public class TarefaController : ControllerBase
    {
        ...
        {
            var getId = _context.Tarefas.Find(id);
        ...
        public IActionResult ObterPorTitulo(string titulo)
        {
            ...
            var GetByTitle = _context.Tarefas.Where(x => x.Titulo.Contains(titulo)).ToList();
        ...
        public IActionResult ObterPorStatus(EnumStatusTarefa status)
        {
            ...
            var GetByStatus = _context.Tarefas.Where(x => x.Status == status).ToList();
            if (GetByStatus == null || !GetByStatus.Any())
